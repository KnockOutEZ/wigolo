 ...
 *  - crates-io / npm-registry / pypi: structured package-registry JSON with
...
const ENGINE_QUALITY: Record<string, EngineQualityTier> = {
  ...
  'crates-io': 'high',
  // npm registry / PyPI: structured JSON with package name/description/version
  // → high, same class as crates-io.
  'npm-registry': 'high',
  pypi: 'high',
  bing: 'medium',
  bing_news: 'medium',
