...
//
// MDN, crates.io, and pypi are admitted as SECONDARY engines — they still
// run, but the orchestrator demotes results contributed only by secondary
// engines when their lexical alignment with the query is low. This keeps
// MDN available for genuine JS/HTML/CSS queries (crates.io for Rust crates,
// pypi for Python packages) while preventing narrow-topic pages from
// hijacking results for unrelated queries like "pgvector HNSW".
