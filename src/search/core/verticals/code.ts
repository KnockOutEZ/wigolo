...
//
// MDN, crates.io, and npm-registry are admitted as SECONDARY engines — they
// still run, but the orchestrator demotes results contributed only by
...
// crates, npm-registry for JS packages) while preventing narrow-topic pages
// from hijacking results for unrelated queries like "pgvector HNSW".
